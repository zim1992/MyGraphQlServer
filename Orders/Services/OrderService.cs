...
namespace Orders.Services
{
    public class OrderService : IOrderService
    {
        ...
        public OrderService(IList<Order> orders)
        {
            _orders = new List<Order>
            {
                ...
                new Order(name: "Table", description: "used for working", created: DateTime.Today.AddDays(4),
                    customerId: new Guid("360506b3-003e-48b2-a5b7-655b401ae1b4")),
                new Order(name: "Computer", description: "used for writing information", created: DateTime.Today.AddDays(9),
                    customerId: new Guid("360506b3-003e-48b2-a5b7-655b401ae1b4")),
                new Order(name: "keyboard", description: "used for importing information into a computer", created: DateTime.Today.AddDays(34),
                    customerId: new Guid("360506b3-003e-48b2-a5b7-655b401ae1b4")),
